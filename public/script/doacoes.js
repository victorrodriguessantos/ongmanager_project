...
document
  ...
  .addEventListener("click", async () => {
    try {
      ...
      // Criar um array formatado para exportação, incluindo o nome do projeto
      const dadosExcel = doacoes.map((doacao) => ({
        ...
        Valor: `R$ ${parseFloat(doacao.valor_doacao || 0)
          ...
          .replace(".", ",")}`,
        Projeto:
          doacao.name_projeto || "Sem projeto vinculado ou projeto excluido", // 🔹 Adiciona nome do projeto ou "Não vinculado"
